// Speichern Sie Ihr neues Logo in einer Variablen
...
// Erstellen Sie einen MutationObserver, um auf Änderungen in der DOM-Struktur zu hören
const observer = new MutationObserver(() => {
  // Trennen Sie den Beobachter vorübergehend
  observer.disconnect();

  // Ersetzen Sie das Logo
  replaceLogo();

  // Verbinden Sie den Beobachter erneut
  observer.observe(document, { childList: true, subtree: true });
});

// Beginnen Sie mit der Beobachtung des gesamten Dokuments
observer.observe(document, { childList: true, subtree: true });

// Ersetzen Sie zunächst alle vorhandenen Logos
replaceLogo();
